...
- Building the modeled layer in BigQuery and dbt, with declarative tests and column-level documentation, on top of a GCP platform I helped migrate from an empty environment. Once the KPI definitions lived in one place, the tickets asking what a number meant fell 80%, around $28K a year that used to go into answering them
