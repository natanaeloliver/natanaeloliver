...
- Building the modeled layer in BigQuery and dbt, with declarative tests and column-level documentation, on top of a GCP platform I helped migrate from an empty environment. Unifying the KPI and business-rule definitions there cut 80% of the tickets raised over KPI definitions, around $28K a year of the time spent answering them
